...
def load_dataset():
    car= glob.glob("./dataset/vehicles/GTI_Far/*.png")
    car+= glob.glob("./dataset/vehicles/GTI_Left/*.png")
    car += glob.glob("./dataset/vehicles/GTI_Right/*.png")
    car += glob.glob("./dataset/vehicles/GTI_MiddleClose/*.png")
